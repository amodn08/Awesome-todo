  ...
  <q-page padding>
    <q-list bordered padding class="q-mb-md">
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section side>
          <q-toggle v-model="showTasksInOneList" color="red" />
        </q-item-section>
      </q-item>
    </q-list>
    ...
    <q-list bordered padding>
      ...
      <q-item to="/settings/auth" tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Login or SignUp</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-icon name="chevron_right" />
        </q-item-section>
  ...
  methods: {
    ...
    emailUs() {
      window.location.href =
        "mailto:amodnagbhidkar08@gmail?subject=Awesome Todo Feedback";
    },
  },
};
</script>
